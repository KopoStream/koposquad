...
<nav className="fixed left-0 right-0 top-0 z-[70] border-b border-purple-500/20 bg-black/85 backdrop-blur-xl">
  ...
  className="flex h-10 w-10 items-center justify-center rounded-xl border border-purple-500/30 bg-purple-500/[0.06] text-purple-300 transition hover:border-purple-400/60 hover:bg-purple-500/[0.12] hover:text-white"
>
<svg
  viewBox="0 0 24 24"
  fill="none"
          ...
          {!searchQuery.trim() ? (
            ...
            <div className="rounded-2xl border border-red-500/15 bg-red-500/[0.04] px-5 py-4">
              <p className="text-sm text-gray-400">
                Hakusanalla{" "}
                <strong className="text-white">"{searchQuery}"</strong> ei löytynyt tuloksia.
              </p>
            </div>
          )}
        </div>
