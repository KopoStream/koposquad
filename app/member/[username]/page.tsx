      ...
      <nav className="fixed left-0 right-0 top-0 z-50 border-b border-purple-500/20 bg-black/80 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5">
          ...
          <div className="hidden items-center gap-6 text-sm md:flex">
            <a href="/" className="text-gray-300 transition hover:text-purple-400">
              Etusivu
            </a>

            <a href="/#live" className="text-gray-300 transition hover:text-purple-400">
              Live
            </a>

            <a href="/#clips" className="text-gray-300 transition hover:text-purple-400">
              Clips
            </a>

            <a href="/#tiimi" className="text-gray-300 transition hover:text-purple-400">
              Tiimi
            </a>

            <a href="/#uutiset" className="text-gray-300 transition hover:text-purple-400">
              Uutiset
            </a>

            <a href="/#liity" className="text-gray-300 transition hover:text-purple-400">
              Liity
            </a>
